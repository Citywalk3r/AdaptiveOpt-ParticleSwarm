...
class ParticleSwarm:
    ...
    def create_particle_position_gif(self, particles, iterations, seed, model, neighborhood_topology):
        ...
        for i in range(iterations):
            ...
            y_pos = []
        # build gif
        with imageio.get_writer(f'./gifs/{seed}_{model}_{neighborhood_topology}.gif', mode='I') as writer:
    ...
    def pso(self, init_pos_f, iterations, eval_f, seed, swarm_size, phi1, phi2, neighborhood_topology = "star", model="full", inertia=True, constriction=True, boundaries=None):
            ...
            for _ in range(iterations):
                ...
                for particle in swarm_list:
                    particle.adjust_v(best_particle, ω, K, second_best_particle)
                    particle.move()
...
class Particle:
    ...
    def __init__(self, is_debug, position, eval_f, phi1, phi2, model, particle_velocity_limits):
        ...
        self.x_fitness = 999999999999
        self.p_fitness = 999999999999
        self.neighbors = None
    ...
    def adjust_v(self, best_particle, ω, K, second_best_particle):
