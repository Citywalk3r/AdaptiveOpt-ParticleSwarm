...
class EGGHOLDER:
    ...
    def solve_eggholder(self):
            ...
            for idx, swarm_size in enumerate(swarm_size_list):
                ...
                for seed in seeds:
                    best_list, _ = PS.pso(init_pos_f = self.generate_init_positions, swarm_size=swarm_size, iterations=iterations, eval_f=self.eval_func, 
                                        ...
                                        neighborhood_topology="ring", model="full", inertia=False, constriction=False, 
                                        boundaries = [[-512, 512], [-512,512]], velocity_restriction = True, generate_gifs=True)
        ...
        print(df)
        # df.to_excel("../ps_200it_250s_10seeds_cognition_star.xlsx")
